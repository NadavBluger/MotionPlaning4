...
class RobotInterface(rtdectrl, rtdercv):
    ...
    def move_home(self, speed=0.5, acceleration=0.2, asynchronous=False):
    ...
    def disconnect(self):
        """
        Explicitly disconnect both control and receive interfaces.
        """
        rtdectrl.disconnect(self)
        rtdercv.disconnect(self)
